...
namespace K4os.Hash.xxHash
{
	...
	public partial class XXH64
	{
		...
		public static unsafe ulong DigestOf(void* bytes, int length, ulong seed = 0) =>
			XXH64_hash(bytes, length, seed);
		
		/// <summary>Hash of provided buffer.</summary>
		/// <param name="bytes">Buffer.</param>
		/// <returns>Digest.</returns>
		public static unsafe ulong DigestOf(ReadOnlySpan<byte> bytes, ulong seed = 0)
		{
		...
		/// <param name="length">Length of buffer.</param>
		/// <returns>Digest.</returns>
		public static unsafe ulong DigestOf(byte[] bytes, int offset, int length, ulong seed = 0)
		{
